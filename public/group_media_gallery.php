    ...
    <main class="chat-main media-gallery-main">
        ...
        <section class="media-gallery-page">
            <div class="media-tabs">
                <a class="media-tab <?= $type === 'all' ? 'active' : '' ?>" href="<?= e(group_media_tab_url($groupId, 'all')) ?>">All</a>
                <a class="media-tab <?= $type === 'image' ? 'active' : '' ?>" href="<?= e(group_media_tab_url($groupId, 'image')) ?>">Images</a>
                <a class="media-tab <?= $type === 'voice' ? 'active' : '' ?>" href="<?= e(group_media_tab_url($groupId, 'voice')) ?>">Voice</a>
                <a class="media-tab <?= $type === 'file' ? 'active' : '' ?>" href="<?= e(group_media_tab_url($groupId, 'file')) ?>">Files</a>
            </div>
                    ...
                    <?php foreach ($mediaItems as $item): ?>
                        ...
                        <article class="media-card">
                            ...
                            <div class="media-info">
                                ...
                                <a class="media-open-chat" href="group.php?id=<?= (int)$groupId ?>#group-message-<?= (int)$item['message_id'] ?>">Open in group</a>
                            </div>
                        </article>
                    <?php endforeach; ?>
                </div>
