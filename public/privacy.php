...
<div class="privacy-wrap">
    ...
    <div class="privacy-card">
        ...
        <p>Download a JSON file containing your profile, private messages, group memberships, group messages, stars, archives, mutes, reports you submitted, and scheduled messages.</p>
    ...
    <div class="privacy-card danger-zone">
        ...
        <p>This will anonymize your profile, remove your login email/password, log you out, and prevent future login. Existing messages will remain as <b>Deleted User</b> so other chats do not break.</p>
        <form method="post" action="delete_account.php" onsubmit="return confirm('Delete your account permanently? This cannot be undone.');">
